...
import {
  ...
  getCartVendorId,
  setCartVendorId,
  updateCartQuantity, // Imported the update function
  CartItem,
...
export default function VendorMenuPage() {
  ...
  function addItemToCart(item: MenuItem) {
    ...
    // Check the live cart to see if the item already exists
    ...
    if (existingItem) {
      ...
      // If it doesn't exist, add it fresh with quantity 1
      addToCart({
        itemId: item.id,
        name: item.name,
  ...
  function handleAdd(item: MenuItem) {
    ...
    if (currentCart.length > 0 && currentVendorId && currentVendorId !== vendorId) {
      setPendingItem(item);
      return;
    }
        ...
        {loading ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {menuItems.map((item) => {
              ...
              const addedCount = cartItem?.quantity || 0;
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <button
                      ...
                      className={`mt-6 inline-flex w-full items-center justify-center rounded-3xl px-4 py-3 text-sm font-semibold transition ${
                        addedCount > 0 
                    ...
                    >
                      ...
                      {addedCount > 0 ? `Add more (${addedCount} in cart)` : "Add to cart"}
                    </button>
                  </div>
                </div>
              );
